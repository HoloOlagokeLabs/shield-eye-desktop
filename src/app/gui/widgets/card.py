...
class DetailCard(QFrame):
    def __init__(self, line1, line2, line3, line4, line5, line6, color):
        super().__init__()
        self.setObjectName("Card")
        self.setStyleSheet(f"""
            QFrame {{
        ...
        line6_label.setTextInteractionFlags(Qt.TextInteractionFlag.TextSelectableByMouse)
